...
import cn.wlp.bos.common.FileUtils;
...
public class SubareaAction extends BaseAction<Subarea> {
    ...
    public String pageQuery() {
        ...
        java2Json(pageBean, new String[]{"decidedzone", "subareas"});
        return null;
    }
    ...
    public String findSubareaNoA() {
        List<Subarea> subareaList = subareaService.findSubareaNoA();

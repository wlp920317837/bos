...
<head>
    ...
    <script type="text/javascript">
        ...
        function doDblClickRow(index, rowData) {
            ...
            //combobox回显
            $('#regionCombox').combobox('setValue', rowData.region.id);
        }
    </script>
</head>
...
<div class="easyui-window" title="分区添加修改" id="editSubareaWindow" collapsible="false" minimizable="false"
    ...
    <div style="overflow:auto;padding:5px;" border="false">
        <form id="editForm" action="subareaAction_edit.action" method="post">
            <table class="table-edit" width="80%" align="center">
                <tr class="title">
                    <td colspan="2">分区信息
                ...
                <tr>
                    <td>选择区域</td>
                    <td>
                        <input id="regionCombox" class="easyui-combobox" name="region.id"
                               data-options="valueField:'id',textField:'name',url:'regionAction_listajax',mode:'remote'"/>
                    </td>
                </tr>
                <tr>
